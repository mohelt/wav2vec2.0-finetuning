...
def main():
    ...
    wavdir = os.path.join(datadir, 'directory_of_wav_files')
    trainlist = os.path.join(datadir, 'sets/directory_of_mos_scores_for_training.txt')
    validlist = os.path.join(datadir, 'sets/directory_of_mos_scores_for_validation.txt')
    ...
    for epoch in range(1,1001):
        ...
        for i, data in enumerate(trainloader, 0):
            ...
            inputs = torchaudio.functional.resample(inputs,48000,16000)         
